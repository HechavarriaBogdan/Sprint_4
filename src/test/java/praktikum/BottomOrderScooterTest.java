...
public class BottomOrderScooterTest {
    @Rule
    ...
    public BottomOrderScooterTest(String name, String surname, String address, String phoneNumber, String comment,
     ...
     *  Точка входа в сценарий - кнопка "Заказать" внизу страницы */

    @Test
    public void bottomOrderScooter () throws Exception {
        WebDriver driver = factory.getDriver();
        var mainPage = new MainPage(driver);
        var orderPageFirst = new OrderPageFirst(driver);
        var orderPageSecond = new OrderPageSecond(driver);
        mainPage.open();
        mainPage.bottomOrderClick();
